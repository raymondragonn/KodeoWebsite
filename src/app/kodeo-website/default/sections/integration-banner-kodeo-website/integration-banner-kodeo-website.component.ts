...
@Component({
  selector: 'app-integration-banner-kodeo-website',
  standalone: true,
  imports: [NgbAccordionModule, CarouselModule,CommonModule],
  templateUrl: './integration-banner-kodeo-website.component.html',
  styleUrl: './integration-banner-kodeo-website.component.scss'
})
export class IntegrationBannerKodeoWebsiteComponent {
