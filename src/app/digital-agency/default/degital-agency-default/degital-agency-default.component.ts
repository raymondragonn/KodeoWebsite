...
@Component({
  selector: 'app-degital-agency-default',
  standalone: true,
  imports: [CarouselModule,CommonModule,CountUpModule],
  templateUrl: './degital-agency-default.component.html',
  styleUrl: './degital-agency-default.component.scss'
})
export class DegitalAgencyDefaultComponent {
  logos = [
