...
@Component({
  selector: 'app-project-management-footer',
  standalone: true,
  imports: [FirstFooterNavComponent, SecFooterNavComponent, NewsLatterComponent],
  templateUrl: './project-management-footer.component.html',
  styleUrl: './project-management-footer.component.scss'
})
export class ProjectManagementFooterComponent {
  date = Date.now();
  year!: number;
